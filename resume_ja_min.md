...
- 官民で複数のプロジェクトに参加、プレイングサブマネージャーとして、主にSI・プロダクト開発・運用保守・PoCなどにおけるエンジニアリング業務に従事。
- サブマネージャー兼BEエンジニアとして、4万人が利用するウォーターサーバー注文・配送システムと未上場株売買システムの構築・機能開発・運用保守に従事、PJリードクラスとのクライアントフェイシングやチームリード、設計実装、バグ修正、本番オペレーションを行った。
