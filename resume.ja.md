...
<br>
・2社目の欧州系企業では、法人さま向けDX実現とデジタルコンテンツUX改善のソリューション開発をしていました。Webアプリとモバイルアプリの機能開発・パフォーマンス改善・バグフィックスをしていました。また必要に応じてお客さまへのアジャイルコーチ・キャンペーン効果検証用の小規模データマート構築もしていました。
<br>
