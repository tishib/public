...
<br>
・1社目の日系企業では、行政や法人様向けにオンプレミスのシステムのストレージ周り( Storage Area Network )を管理するためのソフトウェア製品の開発に携わらせてもらいました。また、製品を使ってくれている自治体様の所に常駐し、現地のSEチームと業務システムの開発保守運用にも携わらせてもらいました。
<br>
・2社目の欧州系企業では、法人様のモバイルアプリとWebアプリのDX向上のためのコンサルティングとプロダクト開発、アジャイルコーチング、データマートなどの分析環境の構築をさせてもらいました。
<br>
・現在の3社目の欧米系企業では、法人様のコンシューマ向けWebアプリと業務アプリのDX向上のためのコンサルティングとプロダクト開発、インフラエンジニア、フロントでのクライアントフェイシングをさせてもらっています。
<br>
　直近では、ECと倉庫物流システムのリニューアルPJTにおいて、ECに音声認識機能と画像認識機能を導入するためのPoC検証とプロダクト開発、またそれらの機能を保守運用していくための運用業務の設計と導入、PJT管理を担当させてもらい。
<br>
　CRMとデータマートの開発保守運用PJTにおいては、各システムの保守運用とアクセスするためのセキュリティルームの構築保守運用、またこれらをクライアントのオンプレミス環境に再構築するためのソリューション設計とシステム実装、フロントでのクライアントフェイシングを担当させてもらっています。
<br><br>
・プライベートでは、友人のスタートアップやサイドPJTで、小規模なWebアプリ開発を定期的にさせてもらっています。
<br>
...
某大手電機メーカー様のTV組み込みアプリの開発（2022年6月～現在）※随時更新中
- 【役割】チームリード、アプリ設計開発
- 【開発フレームワーク】 Factoryパターン、Scrum、海外オフショア開発
- 【言語】 Java、Kotlin、XML
- 【バージョン管理】 Gerrit、Git
- 【その他】 Android、Android Studio、Jenkins
<br>
