...
<br>
・1社目の日系企業では、行政と法人様向けのStorage Area Network管理ソフトウェアのプロダクト開発をしていました。また、途中1年間はプロダクトを使ってもらっていた自治体様の業務システムでインフラエンジニアとして開発保守運用をしていました。
<br>
・2社目の欧州系企業では、法人様のモバイルアプリとWebアプリのDX向上のためのコンサルとプロダクト開発、アジャイルコーチング、データマートの構築・分析業務をしていました。
<br>
・現在の3社目の欧米系企業では、法人様のカスタマー向けWebアプリと業務アプリのDX向上のためのコンサルとプロダクト開発、インフラエンジニア、フロントでのクライアントフェイシングをしています。
<br>
...
- 関心があるもの：キャリア(Individual Contributor)、テクノロジー(zig/Arduino IoT/OSS/Web3.0(Prof. TIM'S vision))、貧困児童問題、Society5.0、量子情報(Q-LEAP/QII)
