...
ECやECに関わる業務システムのフルリニューアルPJTでの、PoC検証やアジャイル開発、また業務設計やPJTマネジメントや。
CRMシステムやデータマートPJTでの、アジャイル開発、セキュリティルームやAWSなどのインフラ構築、またインフラ開発運用保守やクライアントフェイシング、技術リードを行っています。
プライベートでは、過去3年ほど知人の会社や個人PJTで小規模なWeb開発を非定期で行っていました。
...
| 2017〜2018年（14ヶ月）|Reaktor Japan株式会社|
