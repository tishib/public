...
CRMシステムとデータマートの保守運用と再構築PJでは、セキュリティルームからプライベートクラウドまでのE2Eのインフラやセキュリティアーキテクトの設計保守運用や、日々の技術的な問題解決の全般をリードさせて頂いています。<br>
・プライベートでは、過去に友人の会社やサイドPJで小規模なWebアプリ開発を手伝わさせてもらいました。<br>
