...
・1社目の日系企業では、行政と法人様のStorage Area Networkを統合管理するためのソフトウェアの開発をしていました。また、途中1年間は製品を使って頂いていた自治体様の業務システムの開発保守運用をさせてもらいました。<br>
・2社目の欧州系企業では、法人様のモバイルアプリやWebアプリのDXを向上するためのコンサルティングやアジャイル開発(フレームワークはScrum、Rapid Application Development)、データマート構築、データ分析をさせてもいました。<br>
・現在の3社目の欧米系企業では、法人様のアプリケーションやインフラ、業務プロセスのUXとDXの向上、および設計開発保守運用など、幅広い領域でエンジニアリングとコンサルティング、クライアントフェイシングをさせてもらっています。<br>
　直近では、ECと倉庫物流システムのリニューアルPJで、アプリケーションに音声や画像認識機能を導入するためのPoCやWebアプリ開発、バックヤードの業務設計、PMなどをさせて頂き。<br>
　CRMとデータマートのシステム保守運用および再構築PJでは、セキュリティルームからプライベートクラウドまでのインフラやセキュリティアーキテクチャ全般の設計保守運用や、日々の技術的問題の解決全般をリードさせてもらっています。<br>
・プライベートでは、友人の会社やサイドPJで小規模なWebアプリ開発を断続的に手伝わさせてもらっていました。<br>
...
- 趣味：[古琴](https://www.youtube.com/watch?v=mlL4GGzxAK4)、競技プログラミング(LeetCode)、自動二輪ツーリング、読書(The Master Algorithm/はじめて読む486/HARD THINGS)、[チャイルドスポンサーシップ(エチオピア)](https://www.worldvision.jp/childsponsor/)、[国内ひとり親家庭フードバンク](https://www.gnjp.org/work/domestic/gohan/)、バスケットボール3x3、個人開発
- 興味があるもの：IC (Individual Contributor)、Service Meshアーキテクチャ、zig、Arduino (IoT)、OSS、エネルギー問題、エジプト数学、Q-LEAP、Society5.0、QII (量子イノベーションイニシアティブ)
