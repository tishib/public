...
・現在の3社目の欧米系企業では、法人様のアプリケーションやインフラ、業務プロセスのUXとDXの向上、および設計開発保守運用など、幅広い領域でエンジニアリングとコンサルティングさせてもらっています。<br>
直近では、ECと倉庫物流システムのリニューアルPJで、音声や画像認識を導入するためのPoCやWebアプリ開発、業務設計、PMなどをさせて頂き。<br>
CRMシステムとデータマートの保守運用と再構築PJでは、セキュリティルームからプライベートクラウドに至るまでのインフラやセキュリティアーキテクチャの設計保守運用や、日々の技術的な問題解決の全般をリードさせてもらっています。<br>
・プライベートでは、過去3年の間に、友人の会社やサイドPJで小規模なWebアプリ開発をしていました。<br>
