...
・2社目の欧州系企業では、クライアントのモバイルアプリやWebアプリのDX/UXコンサルティングやアジャイル開発（開発スタイル：スクラム、RAD(Rapid Application Development)）、BI環境の構築、ビックデータ解析をしていました。<br>
・3社目の欧米系企業では、クライアントのWebアプリやWebシステムについて、幅広くエンジニアリングやコンサルティングをさせてもらっています。<br>
