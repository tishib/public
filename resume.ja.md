...
　直近では、ECと倉庫物流システムのリニューアルPJにおいて、ECアプリに音声認識と画像認識を導入するためのPoC検証や設計実装、認識機能をメンテナンスするための業務設計、PMをさせてもらい。<br>
　CRMとデータマートのPJにおいて、セキュリティルームのような物理的な環境とシステムのインフラエンジニア、またこれらをクライアントのシステムに内製化するためのソリューションアーキテクトとプロダクト開発、フロントでのクライアントフェイシングをさせてもらっています。<br>
