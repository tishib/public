...
## 要約
社会人10年目のソフトウェアエンジニアです。現在の会社は3社目になります。
<br>
・1社目の日系企業では、行政や企業様のシステムのストレージリソースを管理するソフトの開発に携わりました。また、製品を使ってくれているお客様のところに行き、現地のエンジニアチームと一緒にシステムの運用保守にも携わりました。
<br>
・2社目の欧州系企業では、企業様のアプリケーションのUX改善や、社内業務のDXを実現するためのお手伝いをさせてもらいました。主に、Web・モバイルアプリのエンハンスとリファクタリングや、お客様のIT部門の方へのアジャイルコーチング、社内施策の効果検証用の小規模なデータマート構築に携わりました。
<br>
