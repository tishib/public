...
<br>
・1社目の日系企業では、行政や法人さま向けオンプレミス環境ストレージ管理ソフトウェアの製品開発をしていました。また製品を使ってくれているお客さまのところに出向し、現地のIT部門と連携してオンプレミス環境の運用保守もしていました。
<br>
・2社目の欧州系企業では、法人さま向けDX実現とデジタルコンテンツUX改善のソリューション開発をしていました。Webアプリとモバイルアプリの機能開発・パフォーマンス改善・バグフィックスをしていました。また必要に応じてお客さまへのアジャイルコーチ・キャンペーン効果検証用の小規模データマートの構築もしていました。
<br>
・現在の欧米系企業では、いろいろな分野の法人さま向けDX実現のソリューション開発をしています。モバイルアプリ音声検索機能のPoC検証・スクラッチ開発・運用業務設計、ECサイトフルリニューアル、CRMやデータマートシステムのセキュリティルームや業務端末など物理的設備を含む運用インフラの整備運営・運用保守・再構築、機械学習やペイン分析業務用Webアプリのスクラッチ開発、TV組み込みアプリの設計機能開発・バグフィックス、社内MISの機能開発・バグフィックス・開発フレームワーク整備(WebコンポーネントやBEサブシステム)をしています。
<br>
<br>
