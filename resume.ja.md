...
<br>
・1社目の日系企業では、行政や法人さま向けにオンプレミスのストレージ管理ソフトのプロダクト開発をしていました。またプロダクトを使ってくれているお客さまのところに出向し、現地のIT部門等と一緒にシステムの運用保守をしていました。
<br>
...
<br>
・現在の欧米系企業では、いろいろな分野の企業さま向けにデジタルコンテンツのDX実現のソリューション開発をしています。モバイルアプリ音声検索機能のPoC検証・スクラッチ開発・運用業務設計、ECサイトのフルリニューアル、CRMやデータマートのシステムとセキュリティルームなどの物理的な関連設備を含めたインフラ開発・運用保守、機械学習ペイン分析業務アプリのスクラッチ開発、TV組み込みアプリのアーキ設計・機能開発・バグフィックス、社内BIシステムのアーキ設計・機能開発・フレームワーク開発・バグフィックスをしています。
<br>
<br>
