...
<br>
・1社目の日系企業では、行政や法人さま向けにオンプレミスのストレージ管理ソフトの製品開発をしていました。また製品を使ってくれているお客様のところに出向し、現地のIT部門等と一緒にシステムの運用保守もしていました。
<br>
・2社目の欧州系企業では、法人さまデジタルコンテンツにおけるUX改善とDX実現のソリューション開発をしていました。主にWebアプリとモバイルアプリの機能開発・パフォーマンス改善、IT部門の方へのアジャイルコーチ、キャンペーン効果検証用の小規模データマートの構築をしていました。
<br>
・現在の欧米系企業では、いろいろな分野の企業さまのDX実現のソリューション開発をさせてもらっています。モバイルアプリ音声検索機能のPoC検証・スクラッチ開発・運用業務設計、ECサイトのフルリニューアル、CRMやデータマートのシステムとセキュリティルームなどの物理的な関連設備を含めたインフラ開発・運用保守、機械学習ペイン分析業務アプリのスクラッチ開発、TV組み込みアプリのアーキ設計・機能開発・バグフィックス、社内BIシステムのアーキ設計・機能開発・フレームワーク開発・バグフィックスをしています。
<br>
<br>
・プライベートでは友人のスタートアップの受諾開発や、小規模Webアプリの個人プロジェクトを非定期的にしています。
<br>
