...
<br>
・最初の日系企業では、行政や企業様のシステムの大規模ストレージリソースを管理するためのソフトの開発に関わらせてもらいました。また、製品を使ってくれている自治体様のところに行き、現地のエンジニアチームと一緒に業務システムの運用開発保守にも関わらせてもらいました。
<br>
・次のヨーロッパ系企業では、企業様のアプリケーションにおけるUX向上やDX実現のお手伝いをさせてもらいました。アプリの機能拡張や、お客様の開発チームへのアジャイルコーチング、効果検証用の小規模なデータマートの構築に関わらせてもらいました。
<br>
...
- 【役割】チームリード、Webアプリエンジニア(FE・BE)、アーキテクト
<br>
