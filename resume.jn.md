...
### サマリー
フロントエンド・バックエンドの両方で大規模・小規模なウォーターフォール開発・アジャイル開発の経験があります。
そして自身の短期的・中期的な市場価値向上のため、常に新しいテクノロジー・トレンドテクノロジーを使ってミニマムプロダクトを製作しています。
また、将来的に独立することも視野に入れ、アドバイザーまたはデベロッパーとしてスタートアップと積極的に関わっています。
