...
### サマリー
フロントエンドとバックエンドの両方で、大規模から小規模までのウォーターフォール開発またはアジャイル開発の経験があります。
また、エンジニアとしての市場価値向上のため、業務時間外で、新しいテクノロジーまたはトレンドテクノロジーを使ったミニマムプロダクトを個人開発しています。そして、将来独立することも視野に、アドバイザーまたはデベロッパーとして、スタートアップと積極的に関わっています。
