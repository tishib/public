...
### サマリー
フロントエンドとバックエンドの両方で大規模から小規模までのウォーターフォール開発またはアジャイル開発の経験があります。
そして自身の短期的な市場価値向上のため、日々、新しいテクノロジーあるいはトレンドテクノロジーを使ったミニマムプロダクトを製作しています。
また将来的に独立することも考え、アドバイザーまたはデベロッパーとしてスタートアップと積極的に関わっています。
