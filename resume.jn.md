...
### サマリー
フロントエンド/バックエンドの両方で大規模/小規模なウォーターフォール/アジャイル開発の経験があります。
そして、自分の市場価値向上のため、常に新しい/トレンドテクノロジーを使ってミニマムプロダクトを製作しています。
また大学院時代では、スイスCERN/アメリカFermilabの国際チームと3か月間の共同研究活動を経験しており、多様性のあるチームに対して抵抗がありません。
